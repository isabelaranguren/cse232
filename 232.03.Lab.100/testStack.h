   ...
   void test_pop()
    {
        custom::stack<Spy> s;
        setupStandardFixture(s);
        //fill 4 elements, doesn't matter what is filled in just that we have 4 elements.
        //    +----+----+----+----+
        //    | 26 | 49 | 67 | 89 |
        //    +----+----+----+----+
        s.container.reserve(4);
        ...
        //check to see if s.container - 1 element is equal to 3 since we started with 4
